...
public class Weather {
    ...
    public static String getWeather(ModelJSON model, MessageBotVK messageBotVK) throws IOException {

        URL url = new URL("http://api.openweathermap.org/data/2.5/weather?q=" + messageBotVK.text + "&units=metric&APPID=561769eddcb1c6a87b5738e2c1d8f783");
